...
;; URL: https://emacsthemes.com/themes/pastels-on-dark-theme.html
;; Version: 0.01
...
(deftheme pastels-on-dark-aspiers
  "Adam's version of pastels-on-dark

Ported from TextMate by Shane Celis on 2007-01-10.
Tweaked by Adam Spiers from December 2009 onwards.")
...
(custom-theme-set-faces
 ...
 '(magit-diff-hunk-heading-highlight ((t (:foreground "coral" :background "grey35"))))
...
(provide-theme 'pastels-on-dark-aspiers)
