...
_SPC_ whitespace-mode:   %s(format3 whitespace-mode) ^^^^^^^^^^     _W_ word-wrap:         %s(format3 word-wrap) ^^^^^^^^^^^^^^^^
                           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^   _TAB_ indent-tabs-mode:  %s(format3 indent-tabs-mode)
"
    ("a" abbrev-mode nil)
