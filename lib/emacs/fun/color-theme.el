...
Includes custom, fl, font-lock, gnus, message, widget."
  ...
  (color-theme-install
   '(color-theme-dark-laptop
     ...
     (message-mml-face ((t (:bold t :background nil :foreground "Green3" :inverse-video t))))
     (message-separator-face ((t (:foreground "blue3"))))
     (modeline ((t (:background "black" :foreground "white" :inverse-video t))))
     (modeline-buffer-id ((t (:background "black" :foreground "white" :inverse-video t))))
...
vhdl, viper, w3m, widget, woman, x-symbol, xref."
  ...
  (color-theme-install
   '(color-theme-digital-ofs1
    ...
    (message-url ((t (:bold t :foreground "pink"))))
    (mmm-face ((t (:background "black" :foreground "green"))))
    (modeline ((t (:bold t :background "#CA94AA469193" :foreground "Black" :inverse-video t))))
