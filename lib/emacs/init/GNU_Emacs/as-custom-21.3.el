...
")
 ...
 '(org-todo-keywords (quote ((sequence "NEXT(n)" "STARTED(>)" "|" "DONE") (sequence "PROJECT(p)" "PROJDONE(P)") (sequence "WAITING(w@)" "CHASE(C@)" "|") (sequence "SOMEDAY(s)" "MAYBE(m)" "|" "CANCELLED(c@)"))))
