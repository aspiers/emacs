...
")
 ...
 '(org-todo-keyword-faces (quote (("STARTED" :foreground "LimeGreen" :bold t :weight bold) ("CHASE" :foreground "DarkOrange" :bold t :weight bold) ("WAITING" :foreground "#ffe000" :bold t :weight bold) ("PROJECT" :foreground "purple1" :background "AntiqueWhite1" :bold t :weight bold) ("SOMEDAY" :foreground "gray60" :bold t :weight bold) ("MAYBE" :foreground "gray85" :bold t :weight bold))))
