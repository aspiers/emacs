...
")
 ...
 '(guide-key/guide-key-sequence
   (quote
    ("C-x 4" "C-x r" "C-x v" "C-x 8" "C-x p" "C-c i" "C-c g" "C-c m" "C-c t" "C-c w" "C-c j" "M-o" "zp" "pz" "<key-chord>"
     (dired-mode "%" "*" "C-t"))))
